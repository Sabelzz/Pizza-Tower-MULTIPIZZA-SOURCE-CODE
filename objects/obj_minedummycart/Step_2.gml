...
if (scr_solid((x + sign(image_xscale)), y, 1) && (!(place_meeting((x + sign(image_xscale)), y, obj_destructibles))) && (!(place_meeting((x + sign(image_xscale)), y, obj_metalblock))) && (!(place_meeting((x + sign(image_xscale)), y, obj_chocofrog))))
{
