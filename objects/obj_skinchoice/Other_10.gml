...
switch character
{
	...
	default:
		...
		add_palette(12, "", spr_pattern_twitter, "Controversial", "Who-a said you had a Opinion-a?");
		add_palette(12, "", spr_pattern_snow, "Snow", "This feels familiar");
		break;
	...
	case "G":
		...
		add_palette(12, "", spr_pattern_mobius, "Mobius Strip", "Gotta' speed, Keed.");
		add_palette(12, "", spr_pattern_spaceinvader, "Space Invaders", "Invaders must die.");
		add_palette(12, "", spr_pattern_twitter, "Controversial", "This place fucking sucks.");
		add_palette(12, "", spr_pattern_snow, "Snow", "This guy loves me!");
		break;
	...
	case "N":
		...
		add_palette(8, "", noone, "Eitan", "Why the fuck is this dude so green??", "SKY");
		add_palette(9, "", noone, "Sabel", "This mf is so cool!", "CUTE");
		...
		add_palette(12, "", spr_pattern_mobius, "Mobius Strip", "Gotta' speed, Keed.");
		add_palette(12, "", spr_pattern_spaceinvader, "Space Invaders", "Invaders must die.");
		add_palette(12, "", spr_pattern_twitter, "Controversial", "Noise says: YOU DONT HAVE A DAMN OPINION");
		add_palette(12, "", spr_pattern_snow, "Snow", "HOLY FUCKING SHIT IS THAT SNOW FROM GAMEJOLT FROM GAMEJOLT.COM THAT STREAMS EVERYDAY AND IS ALSO A BUG TESTER AND OR PLAYTESTER FOR THIS CERTIAN MOD CALLED PTWF?!?!?");
		break;
	...
	case "SP":
		...
		add_palette(12, "", spr_pattern_mobius, "Mobius Strip", "Gotta' speed, Keed.");
		add_palette(12, "", spr_pattern_spaceinvader, "Space Invaders", "Invaders must die.");
		add_palette(12, "", spr_pattern_twitter, "Controversial", "free sugary spire builds from sugaryspire.org!");
		add_palette(12, "", spr_pattern_snow, "Snow", "Its snowin outside!");
		break;
	...
	case "PN":
		...
		add_palette(12, "", spr_pattern_twitter, "Controversial", "I LOVE THIS PLACE");
		add_palette(12, "", spr_pattern_snow, "Snow", "snow");
		break;
