function scr_characterspr()
{
	...
	if (character == "SP")
	{
		...
		//spr_jump2 = spr_player_jump2;
		spr_shotgunshoot = spr_playerSP_candyshoot;
		spr_shotgunidle = spr_playerSP_candyidle;
		spr_shotgunwalk = spr_playerSP_candywalk;
	...
	if character == "S"
	{
		...
		*/
		...
		if (character == "PT")
	{
		global.mach_color1 = make_colour_rgb(166, 180, 219);
		global.mach_color2 = make_colour_rgb(166, 180, 219);
		...
		spr_idle = spr_player_peter;
		spr_move = spr_player_peter;
		spr_crawl = spr_player_peter;
		spr_hurt = spr_player_peter;
		spr_jump = spr_player_peter;
		spr_fall = spr_player_peter;
		spr_crouch = spr_player_peter;
		spr_crouchjump = spr_player_peter;
		spr_crouchfall = spr_player_peter;
		spr_couchstart = spr_player_peter;
		spr_bump = spr_player_peter;
		spr_land = spr_player_peter;
		spr_land2 = spr_player_peter;
		spr_lookdoor = spr_player_peter;
		spr_walkfront = spr_player_peter;
		spr_victory = spr_player_peter;
		spr_Ladder = spr_player_peter;
		spr_laddermove = spr_player_peter;
		spr_ladderdown = spr_player_peter;
		spr_keyget = spr_player_peter;
		spr_crouchslip = spr_player_peter;
		spr_pistolshot = spr_player_peter;
		spr_pistolwalk = spr_player_peter;
		spr_mach1 = spr_player_peter;
		spr_mach = spr_player_peter;
		spr_secondjump1 = spr_player_peter;
		spr_secondjump2 = spr_player_peter;
		spr_machslidestart = spr_player_peter;
		spr_machslide = spr_player_peter;
		spr_machslideend = spr_player_peter;
		spr_machslideboost = spr_player_peter;
		spr_land2 = spr_player_peter;
		spr_stomp = spr_player_peter;
		spr_stompprep = spr_player_peter;
		spr_crouchslide = spr_player_peter;
		spr_crouch = spr_player_peter;
		spr_bump = spr_player_peter;
		spr_victory = spr_player_peter;
		spr_hurt = spr_player_peter;
		spr_climbwall = spr_player_peter;
		spr_mach2jump = spr_player_peter;
		spr_Timesup = spr_player_peter;
		spr_deathend = spr_player_peter;
		spr_machpunch1 = spr_player_peter;
		spr_machpunch2 = spr_player_peter;
		spr_hurtjump = spr_player_peter;
		spr_entergate = spr_player_peter;
		spr_gottreasure = spr_player_peter;
		spr_bossintro = spr_player_peter;
		spr_hurtidle = spr_player_peter;
		spr_hurtwalk = spr_player_peter;
		spr_suplexmash1 = spr_player_peter;
		spr_suplexmash2 = spr_player_peter;
		spr_suplexmash3 = spr_player_peter;
		spr_suplexmash4 = spr_player_peter;
		spr_keyget = spr_player_peter;
		spr_idle1 = spr_player_peter;
		spr_idle2 = spr_player_peter;
		spr_idle3 = spr_player_peter; // placeholder
		spr_idle4 = spr_player_peter;
		spr_idle5 = spr_player_peter;
		spr_idle6 = spr_player_peter; // placeholder
		spr_piledriver = spr_player_peter;
		spr_piledriverland = spr_player_peter;
		spr_mach3jump = spr_player_peter;
		spr_mach4 = spr_player_peter;
		spr_machclimbwall = spr_player_peter;
		spr_dive = spr_player_peter;
		spr_machroll = spr_player_peter;
		spr_hitwall = spr_player_peter;
		spr_superjumpland = spr_player_peter;
		spr_walljumpstart = spr_player_peter;
		spr_superjumpprep = spr_player_peter;
		spr_superjump = spr_player_peter;
		spr_superjumppreplight = spr_player_peter;
		spr_superjumpright = spr_player_peter;
		spr_superjumpleft = spr_player_peter;
		spr_machfreefall = spr_player_peter;
		spr_mach3hit = spr_player_peter;
		spr_knightpepwalk = spr_player_peter;
		spr_knightpepjump = spr_player_peter;
		spr_knightpepfall = spr_player_peter;
		spr_knightpepidle = spr_player_peter;
		spr_knightpepjumpstart = spr_player_peter;
		spr_knightpepthunder = spr_player_peter;
		spr_knightpepland = spr_player_peter;
		spr_knightpepdownslope = spr_player_peter;
		spr_knightpepstart = spr_player_peter;
		spr_knightpepcharge = spr_player_peter;
		spr_knightpepfly = spr_player_peter;
		spr_knightpepdownthrust = spr_player_peter;
		spr_knightpepupslope = spr_player_peter;
		spr_bodyslamfall = spr_player_peter;
		spr_bodyslamstart = spr_player_peter;
		spr_bodyslamland = spr_player_peter;
		spr_crazyrun = spr_player_peter;
		spr_bombpeprun = spr_player_peter; // isn't this unused since like sage or whatever
		spr_bombpepintro = spr_player_peter; // same shit here
		spr_bombpeprunabouttoexplode = spr_player_peter; //and again here (loypoll commenting) (this is a JOKE NOT A JAB)
		spr_bombpepend = spr_player_peter;
		spr_fireass = spr_player_peter;
		spr_fireassground = spr_player_peter;
		spr_tumblestart = spr_player_peter; // unused isn't it
		spr_tumbleend = spr_player_peter;
		spr_tumble = spr_player_peter;
		spr_stunned = spr_player_peter;
		spr_clown = spr_player_peter;
		spr_clownbump = spr_player_peter;
		spr_clowncrouch = spr_player_peter;
		spr_clownfall = spr_player_peter;
		spr_clownjump = spr_player_peter;
		spr_clownwallclimb = spr_player_peter;
		spr_downpizzabox = spr_player_peter;
		spr_uppizzabox = spr_player_peter;
		spr_slipnslide = spr_player_peter;
		spr_mach3boost = spr_player_peter;
		spr_facehurtup = spr_player_peter;
		spr_facehurt = spr_player_peter;
		spr_walljumpend = spr_player_peter;
		spr_suplexdash = spr_player_peter;
		spr_suplexdashjumpstart = spr_player_peter;
		spr_suplexdashjump = spr_player_peter;
		spr_shotgunsuplexdash = spr_player_peter;
		spr_rollgetup = spr_player_peter;
		spr_swingding = spr_player_peter;
		spr_swingdingend = spr_player_peter;
		spr_haulingjump = spr_player_peter;
		spr_haulingidle = spr_player_peter;
		spr_haulingwalk = spr_player_peter;
		spr_haulingstart = spr_player_peter;
		spr_haulingfall = spr_player_peter;
		spr_haulingland = spr_player_peter;
		spr_uppercutfinishingblow = spr_player_peter;
		spr_finishingblow1 = spr_player_peter;
		spr_finishingblow2 = spr_player_peter;
		spr_finishingblow3 = spr_player_peter;
		spr_finishingblow4 = spr_player_peter;
		spr_finishingblow5 = spr_player_peter;
		spr_winding = spr_player_peter;
		spr_3hpwalk = spr_player_peter;
		spr_3hpidle = spr_player_peter;
		spr_panic = spr_player_peter;
		spr_facestomp = spr_player_peter;
		spr_freefall = spr_player_peter;
		spr_shotgunland = spr_player_peter;
		spr_shotgunshoot = spr_player_peter;
		spr_shotgunidle = spr_player_peter;
		spr_shotgunwalk = spr_player_peter;
		spr_shotgunfall = spr_player_peter;
		spr_shotgunjump = spr_player_peter;
		spr_shotgunjump1 = spr_player_peter;
		spr_shotgunjump2 = spr_player_peter;
		spr_shotgunjump3 = spr_player_peter;
		spr_shotgunpullout = spr_player_peter;
		spr_shotgunduck = spr_player_peter;
		spr_shotguncrawl = spr_player_peter;
		spr_shotgungoduck = spr_player_peter;
		spr_fightball = spr_player_peter;
		spr_squished = spr_player_peter;
		spr_supertaunt1 = spr_player_peter;
		spr_supertaunt2 = spr_player_peter;
		spr_supertaunt3 = spr_player_peter; // placeholder
		spr_supertaunt4 = spr_player_peter; // placeholder
		spr_taunt = spr_player_peter;
		spr_rideweenie = spr_player_peter;
		spr_weenieturn = spr_player_peter;
		spr_breakdance = spr_player_peter;
		spr_breakdancesuper = spr_player_peter;
		spr_dashpadmach = spr_player_peter;
		spr_firemouthintro = spr_player_peter;
		spr_firemouthend = spr_player_peter;
		spr_firemouth = spr_player_peter;
		spr_ghostdash = spr_player_peter;
		spr_ghostidle = spr_player_peter;
		spr_ghostend = spr_player_peter;
		spr_ghostjump = spr_player_peter;
		spr_mortdoublejumpstart = spr_player_peter;
		spr_mortdoublejump = spr_player_peter;
		spr_barrelroll = spr_player_peter;
		spr_scaredjump1 = spr_player_peter;
		spr_scaredjump2 = spr_player_peter;
		spr_currentplayer = spr_player_peter;
		spr_golfidle = spr_player_peter;
		spr_golfswing = spr_player_peter;
		spr_cheeseballplayer = spr_player_peter;
		spr_boxxedpepintro = spr_player_peter;
		spr_boxxedpepidle = spr_player_peter;
		spr_boxxedpepwalk = spr_player_peter;
		spr_boxxedpepair = spr_player_peter;
		spr_boxxedpepdashstart = spr_player_peter;
		spr_boxxedpepdashend = spr_player_peter;
		spr_boxxedpepdash = spr_player_peter;
		spr_cheesepepintro = spr_player_peter;
		spr_cheesepepidle = spr_player_peter;
		spr_cheesepepwalk = spr_player_peter;
		spr_cheesepepjump = spr_player_peter;
		spr_cheesepepjumpstart = spr_player_peter;
		spr_cheesepepfall = spr_player_peter;
		spr_cheesepepland = spr_player_peter;
		spr_cheesepepstickside = spr_player_peter;
		spr_cheesepepstickceiling = spr_player_peter;
		spr_cheesepepstickfloor = spr_player_peter;
		spr_rocketstart = spr_player_peter;
		spr_rocket = spr_player_peter;
		spr_rockethitwall = spr_player_peter;
		spr_slipbanan1 = spr_player_peter;
		spr_slipbanan2 = spr_player_peter;
		spr_rageidle = spr_player_peter;
		spr_ragemove = spr_player_peter;
		spr_parry1 = spr_player_peter;
		spr_parry2 = spr_player_peter;
		spr_parry3 = spr_player_peter;
		spr_dead = spr_player_peter;
		spr_suplexbump = spr_player_peter;
		spr_grind = spr_player_peter;
		spr_suplexland = spr_player_peter;
		spr_superspringplayer = spr_player_peter;
		spr_suplexcancel = spr_player_peter;
		spr_machslideboostfall = spr_player_peter;
		spr_machslideboost3fall = spr_player_peter;
		spr_breakdanceuppercut = spr_player_peter;
		spr_breakdanceuppercutend = spr_player_peter;
		spr_poundcancel1 = spr_player_peter;
		spr_poundcancel2 = spr_player_peter;
		spr_Sjumpcancelstart = spr_player_peter;
		spr_Sjumpcancel = spr_player_peter;
		spr_freezeridle = spr_player_peter;
		spr_rampjump = spr_player_peter;
		spr_wallsplat = spr_player_peter;
	}
				if (character == "CH")
	{
		global.mach_color1 = make_colour_rgb(166, 180, 219);
		...
		snd_voiceok = fmod_event_create_instance("event:/ptt/sfx/metalpipechung");
		snd_voicetransfo = fmod_event_create_instance("event:/ptt/sfx/metalpipechung");
		snd_voiceouttransfo = fmod_event_create_instance("event:/ptt/sfx/metalpipechung");
		snd_voicehurt = fmod_event_create_instance("event:/ptt/sfx/metalpipechung");
		global.snd_fireass = fmod_event_create_instance("event:/ptt/sfx/vineboom");
		
		spr_idle = spr_player_chung;
		spr_move = spr_player_chung;
		spr_crawl = spr_player_chung;
		spr_hurt = spr_player_chung;
		spr_jump = spr_player_chung;
		spr_fall = spr_player_chung;
		spr_crouch = spr_player_chung;
		spr_crouchjump = spr_player_chung;
		spr_crouchfall = spr_player_chung;
		spr_couchstart = spr_player_chung;
		spr_bump = spr_player_chung;
		spr_land = spr_player_chung;
		spr_land2 = spr_player_chung;
		spr_lookdoor = spr_player_chung;
		spr_walkfront = spr_player_chung;
		spr_victory = spr_player_chung;
		spr_Ladder = spr_player_chung;
		spr_laddermove = spr_player_chung;
		spr_ladderdown = spr_player_chung;
		spr_keyget = spr_player_chung;
		spr_crouchslip = spr_player_chung;
		spr_pistolshot = spr_player_chung;
		spr_pistolwalk = spr_player_chung;
		spr_mach1 = spr_player_chung;
		spr_mach = spr_player_chung;
		spr_secondjump1 = spr_player_chung;
		spr_secondjump2 = spr_player_chung;
		spr_machslidestart = spr_player_chung;
		spr_machslide = spr_player_chung;
		spr_machslideend = spr_player_chung;
		spr_machslideboost = spr_player_chung;
		spr_land2 = spr_player_chung;
		spr_stomp = spr_player_chung;
		spr_stompprep = spr_player_chung;
		spr_crouchslide = spr_player_chung;
		spr_crouch = spr_player_chung;
		spr_bump = spr_player_chung;
		spr_victory = spr_player_chung;
		spr_hurt = spr_player_chung;
		spr_climbwall = spr_player_chung;
		spr_mach2jump = spr_player_chung;
		spr_Timesup = spr_player_chung;
		spr_deathend = spr_player_chung;
		spr_machpunch1 = spr_player_chung;
		spr_machpunch2 = spr_player_chung;
		spr_hurtjump = spr_player_chung;
		spr_entergate = spr_player_chung;
		spr_gottreasure = spr_player_chung;
		spr_bossintro = spr_player_chung;
		spr_hurtidle = spr_player_chung;
		spr_hurtwalk = spr_player_chung;
		spr_suplexmash1 = spr_player_chung;
		spr_suplexmash2 = spr_player_chung;
		spr_suplexmash3 = spr_player_chung;
		spr_suplexmash4 = spr_player_chung;
		spr_keyget = spr_player_chung;
		spr_idle1 = spr_player_chung;
		spr_idle2 = spr_player_chung;
		spr_idle3 = spr_player_chung; // placeholder
		spr_idle4 = spr_player_chung;
		spr_idle5 = spr_player_chung;
		spr_idle6 = spr_player_chung; // placeholder
		spr_piledriver = spr_player_chung;
		spr_piledriverland = spr_player_chung;
		spr_mach3jump = spr_player_chung;
		spr_mach4 = spr_player_chung;
		spr_machclimbwall = spr_player_chung;
		spr_dive = spr_player_chung;
		spr_machroll = spr_player_chung;
		spr_hitwall = spr_player_chung;
		spr_superjumpland = spr_player_chung;
		spr_walljumpstart = spr_player_chung;
		spr_superjumpprep = spr_player_chung;
		spr_superjump = spr_player_chung;
		spr_superjumppreplight = spr_player_chung;
		spr_superjumpright = spr_player_chung;
		spr_superjumpleft = spr_player_chung;
		spr_machfreefall = spr_player_chung;
		spr_mach3hit = spr_player_chung;
		spr_knightpepwalk = spr_player_chung;
		spr_knightpepjump = spr_player_chung;
		spr_knightpepfall = spr_player_chung;
		spr_knightpepidle = spr_player_chung;
		spr_knightpepjumpstart = spr_player_chung;
		spr_knightpepthunder = spr_player_chung;
		spr_knightpepland = spr_player_chung;
		spr_knightpepdownslope = spr_player_chung;
		spr_knightpepstart = spr_player_chung;
		spr_knightpepcharge = spr_player_chung;
		spr_knightpepfly = spr_player_chung;
		spr_knightpepdownthrust = spr_player_chung;
		spr_knightpepupslope = spr_player_chung;
		spr_bodyslamfall = spr_player_chung;
		spr_bodyslamstart = spr_player_chung;
		spr_bodyslamland = spr_player_chung;
		spr_crazyrun = spr_player_chung;
		spr_bombpeprun = spr_player_chung; // isn't this unused since like sage or whatever
		spr_bombpepintro = spr_player_chung; // same shit here
		spr_bombpeprunabouttoexplode = spr_player_chung; //and again here (loypoll commenting) (this is a JOKE NOT A JAB)
		spr_bombpepend = spr_player_chung;
		spr_fireass = spr_player_chung;
		spr_fireassground = spr_player_chung;
		spr_tumblestart = spr_player_chung; // unused isn't it
		spr_tumbleend = spr_player_chung;
		spr_tumble = spr_player_chung;
		spr_stunned = spr_player_chung;
		spr_clown = spr_player_chung;
		spr_clownbump = spr_player_chung;
		spr_clowncrouch = spr_player_chung;
		spr_clownfall = spr_player_chung;
		spr_clownjump = spr_player_chung;
		spr_clownwallclimb = spr_player_chung;
		spr_downpizzabox = spr_player_chung;
		spr_uppizzabox = spr_player_chung;
		spr_slipnslide = spr_player_chung;
		spr_mach3boost = spr_player_chung;
		spr_facehurtup = spr_player_chung;
		spr_facehurt = spr_player_chung;
		spr_walljumpend = spr_player_chung;
		spr_suplexdash = spr_player_chung;
		spr_suplexdashjumpstart = spr_player_chung;
		spr_suplexdashjump = spr_player_chung;
		spr_shotgunsuplexdash = spr_player_chung;
		spr_rollgetup = spr_player_chung;
		spr_swingding = spr_player_chung;
		spr_swingdingend = spr_player_chung;
		spr_haulingjump = spr_player_chung;
		spr_haulingidle = spr_player_chung;
		spr_haulingwalk = spr_player_chung;
		spr_haulingstart = spr_player_chung;
		spr_haulingfall = spr_player_chung;
		spr_haulingland = spr_player_chung;
		spr_uppercutfinishingblow = spr_player_chung;
		spr_finishingblow1 = spr_player_chung;
		spr_finishingblow2 = spr_player_chung;
		spr_finishingblow3 = spr_player_chung;
		spr_finishingblow4 = spr_player_chung;
		spr_finishingblow5 = spr_player_chung;
		spr_winding = spr_player_chung;
		spr_3hpwalk = spr_player_chung;
		spr_3hpidle = spr_player_chung;
		spr_panic = spr_player_chung;
		spr_facestomp = spr_player_chung;
		spr_freefall = spr_player_chung;
		spr_shotgunland = spr_player_chung;
		spr_shotgunshoot = spr_player_chung;
		spr_shotgunidle = spr_player_chung;
		spr_shotgunwalk = spr_player_chung;
		spr_shotgunfall = spr_player_chung;
		spr_shotgunjump = spr_player_chung;
		spr_shotgunjump1 = spr_player_chung;
		spr_shotgunjump2 = spr_player_chung;
		spr_shotgunjump3 = spr_player_chung;
		spr_shotgunpullout = spr_player_chung;
		spr_shotgunduck = spr_player_chung;
		spr_shotguncrawl = spr_player_chung;
		spr_shotgungoduck = spr_player_chung;
		spr_fightball = spr_player_chung;
		spr_squished = spr_player_chung;
		spr_supertaunt1 = spr_player_chung;
		spr_supertaunt2 = spr_player_chung;
		spr_supertaunt3 = spr_player_chung; // placeholder
		spr_supertaunt4 = spr_player_chung; // placeholder
		spr_taunt = spr_player_chung;
		spr_rideweenie = spr_player_chung;
		spr_weenieturn = spr_player_chung;
		spr_breakdance = spr_player_chung;
		spr_breakdancesuper = spr_player_chung;
		spr_dashpadmach = spr_player_chung;
		spr_firemouthintro = spr_player_chung;
		spr_firemouthend = spr_player_chung;
		spr_firemouth = spr_player_chung;
		spr_ghostdash = spr_player_chung;
		spr_ghostidle = spr_player_chung;
		spr_ghostend = spr_player_chung;
		spr_ghostjump = spr_player_chung;
		spr_mortdoublejumpstart = spr_player_chung;
		spr_mortdoublejump = spr_player_chung;
		spr_barrelroll = spr_player_chung;
		spr_scaredjump1 = spr_player_chung;
		spr_scaredjump2 = spr_player_chung;
		spr_currentplayer = spr_player_chung;
		spr_golfidle = spr_player_chung;
		spr_golfswing = spr_player_chung;
		spr_cheeseballplayer = spr_player_chung;
		spr_boxxedpepintro = spr_player_chung;
		spr_boxxedpepidle = spr_player_chung;
		spr_boxxedpepwalk = spr_player_chung;
		spr_boxxedpepair = spr_player_chung;
		spr_boxxedpepdashstart = spr_player_chung;
		spr_boxxedpepdashend = spr_player_chung;
		spr_boxxedpepdash = spr_player_chung;
		spr_cheesepepintro = spr_player_chung;
		spr_cheesepepidle = spr_player_chung;
		spr_cheesepepwalk = spr_player_chung;
		spr_cheesepepjump = spr_player_chung;
		spr_cheesepepjumpstart = spr_player_chung;
		spr_cheesepepfall = spr_player_chung;
		spr_cheesepepland = spr_player_chung;
		spr_cheesepepstickside = spr_player_chung;
		spr_cheesepepstickceiling = spr_player_chung;
		spr_cheesepepstickfloor = spr_player_chung;
		spr_rocketstart = spr_player_chung;
		spr_rocket = spr_player_chung;
		spr_rockethitwall = spr_player_chung;
		spr_slipbanan1 = spr_player_chung;
		spr_slipbanan2 = spr_player_chung;
		spr_rageidle = spr_player_chung;
		spr_ragemove = spr_player_chung;
		spr_parry1 = spr_player_chung;
		spr_parry2 = spr_player_chung;
		spr_parry3 = spr_player_chung;
		spr_dead = spr_player_chung;
		spr_suplexbump = spr_player_chung;
		spr_grind = spr_player_chung;
		spr_suplexland = spr_player_chung;
		spr_superspringplayer = spr_player_chung;
		spr_suplexcancel = spr_player_chung;
		spr_machslideboostfall = spr_player_chung;
		spr_machslideboost3fall = spr_player_chung;
		spr_breakdanceuppercut = spr_player_chung;
		spr_breakdanceuppercutend = spr_player_chung;
		spr_poundcancel1 = spr_player_chung;
		spr_poundcancel2 = spr_player_chung;
		spr_Sjumpcancelstart = spr_player_chung;
		spr_Sjumpcancel = spr_player_chung;
		spr_freezeridle = spr_player_chung;
		spr_rampjump = spr_player_chung;
		spr_wallsplat = spr_player_chung;
		}
